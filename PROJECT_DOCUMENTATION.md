...
**3.3.3.2.3 Структура проекта (реализованная)**
```
src/main/java/com/example/server1/
...
└── main.html           # Простая HTML страница
```
...
- **Code Review**:
  ...
  - Автоматические проверки (Checkstyle, PMD)
